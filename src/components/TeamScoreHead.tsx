...
const TeamScoreHead: React.FC<TeamAboutProps> = ({ teamName, runs, wickets, overs, balls, total_overs }) => {
    return (
        <div className="w-2/5 flex flex-col justify-center items-center mt-4">
            <div className="shadow-shadow_custom2 size-32 flex justify-center items-center flex-col rounded-xl bg-white">
                <Avatar>
            ...
            <p className="mt-2 text-white text-xl">{runs}/{wickets}</p>
            <p className="text-white text-xl">{overs}.{balls}/{total_overs}(ov)</p>
        </div>
    )
}
